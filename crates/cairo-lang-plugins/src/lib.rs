...
use crate::plugins::derive::basic_trait_derivers;
...
/// Gets the list of default plugins to load into the Cairo compiler.
pub fn get_plugins_for_testing() -> Vec<Arc<dyn MacroPlugin>> {
    let mut plugins = get_default_plugins();
    plugins.push(Arc::new(DerivePlugin::new(basic_trait_derivers())));
    plugins
}
